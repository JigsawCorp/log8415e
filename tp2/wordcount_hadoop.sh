...
do
	...
	do
		...
		(time hadoop jar /usr/lib/hadoop/hadoop-streaming.jar -files log8415e/tp2/mapper.py,log8415e/tp2/reducer.py -mapper mapper.py -reducer reducer.py -input input/data$i.txt -output output/hadoop/data${i}_exec${j} &>> results/hadoop_data${i}_exec${j}.txt) &> results/hadoop_time_tmp.txt 	
