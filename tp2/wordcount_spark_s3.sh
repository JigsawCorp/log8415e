...
do
	...
	do
		...
		(time spark-submit --master yarn log8415e/tp2/wordcount_spark_s3.py data$i.txt results/spark/s3/data${i}_exec${j} &>> results/spark_s3_data${i}_exec${j}.txt) &>> results/spark_s3_time.txt
